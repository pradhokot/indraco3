                        ...
                        <div class="container-lg pb-3">
                           ...
                           <div class="d-flex column-gap-4">
                              <div class="nav flex-column nav-pills" role="tablist">
                                 <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover active" id="tab-link-product-consumer" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer" aria-selected="true">produk konsumen</button>
                                 <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-foodservice" data-bs-toggle="pill" data-bs-target="#tab-pane-product-foodservice" aria-selected="false">layanan makanan</button>
                                 <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-equipment" data-bs-toggle="pill" data-bs-target="#tab-pane-product-equipment" aria-selected="false">mesin-mesin & peralatan khusus</button>
                              </div>
                              <div class="vr"></div>
                              <div class="tab-content">
                                 ...
                                 <div class="tab-pane fade show active" id="tab-pane-product-consumer" role="tabpanel" tabindex="0">
                                    <div class="d-flex column-gap-4">
                                       <div class="nav flex-column nav-pills" role="tablist">
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover active" id="tab-link-product-consumer-supresso" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-supresso" aria-selected="true">supresso</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-balicafe" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-balicafe" aria-selected="false">BaliCafé</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-ucafe" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-ucafe" aria-selected="false">UCAFÉ</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-rasa-sayang" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-rasa-sayang" aria-selected="false">rasa sayang</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-tugu-buaya" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-tugu-buaya" aria-selected="false">tugu buaya</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-uang-emas" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-uang-emas" aria-selected="false">uang emas</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-brochoco" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-brochoco" aria-selected="false">BROCHOCO</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-jaheku" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-jaheku" aria-selected="false">jaheku</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-intirasa" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-intirasa" aria-selected="false">intirasa</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-product-consumer-haocafe" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-haocafe" aria-selected="false">hao cafe</button>
                                       </div>
                                       <div class="vr"></div>
                                       <div class="tab-content">
                           ...
                           <div class="d-flex column-gap-4">
                              ...
                              <div class="tab-content">
                                 ...
                                 <div class="tab-pane fade show active" id="tab-pane-store-ecommerce" role="tabpanel" tabindex="0">
                                    <div class="d-flex column-gap-4">
                                       <div class="nav flex-column nav-pills" role="tablist">
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover active" id="tab-link-store-ecommerce-supresso" data-bs-toggle="pill" data-bs-target="#tab-pane-store-ecommerce-supresso" aria-selected="true">supresso</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-store-ecommerce-indracostore" data-bs-toggle="pill" data-bs-target="#tab-pane-store-ecommerce-indracostore" aria-selected="false">indracostore</button>
                                       </div>
                                       <div class="vr"></div>
                                       <div class="tab-content">
                                 ...
                                 <div class="tab-pane fade" id="tab-pane-store-marketplace" role="tabpanel" tabindex="0">
                                    <div class="d-flex column-gap-4">
                                       <div class="nav flex-column nav-pills" role="tablist">
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover active" id="tab-link-store-marketplace-tokopedia" data-bs-toggle="pill" data-bs-target="#tab-pane-store-marketplace-tokopedia" aria-selected="true">tokopedia</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-store-marketplace-shopee" data-bs-toggle="pill" data-bs-target="#tab-pane-store-marketplace-shopee" aria-selected="false">shopee</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-store-marketplace-lazada" data-bs-toggle="pill" data-bs-target="#tab-pane-store-marketplace-lazada" aria-selected="false">marketplace-lazada</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-store-marketplace-blibli" data-bs-toggle="pill" data-bs-target="#tab-pane-store-marketplace-blibli" aria-selected="false">blibli</button>
                                          <button type="button" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover" id="tab-link-store-marketplace-tiktokshop" data-bs-toggle="pill" data-bs-target="#tab-pane-store-marketplace-tiktokshop" aria-selected="false">tiktok shop</button>
                                       </div>
                                       <div class="vr"></div>
                                       <div class="tab-content">
