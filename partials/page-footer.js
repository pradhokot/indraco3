         ...
         <div class="row row-gap-5 gx-md-5 justify-content-lg-between">
            <div class="col col-12 col-lg-auto order-lg-1 d-lg-flex flex-lg-column">
               ...
               <nav aria-label="navigasi sosial media" class="d-flex flex-wrap gap-3 flex-lg-grow-0">
                  <a href="#" target="_blank" rel="noopener" class="text-reset text-decoration-none opacity-75-hover disabled" aria-label="tautan sosial media X Twitter">
                  ...
                  <a href="#" target="_blank" rel="noopener" class="text-reset text-decoration-none opacity-75-hover disabled" aria-label="tautan sosial media Tiktok">
