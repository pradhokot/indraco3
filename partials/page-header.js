         ...
         <div class="container-xxl flex-column row-gap-lg-3">
            ...
            <div class="navbar-bawah w-100 d-none d-lg-flex align-items-lg-center column-gap-lg-5">
               ...
               <ul aria-label="navigasi desktop" class="list-unstyled mb-0 d-flex flex-wrap gap-3 flex-lg-grow-1">
                           ...
                           <div class="d-flex column-gap-4">
                              ...
                              <div class="tab-content">
                                 ...
                                 <div class="tab-pane fade show active" id="tab-pane-product-consumer" role="tabpanel" tabindex="0">
                                    <div class="d-flex column-gap-4">
                                       <div class="nav flex-column nav-pills" role="tablist">
                                          <button type="button" onclick="brand-supresso.html" class="nav-link text-reset text-start px-0 text-capitalize bg-transparent rounded-0 opacity-75-hover active" id="tab-link-product-consumer-supresso" data-bs-toggle="pill" data-bs-target="#tab-pane-product-consumer-supresso" aria-selected="true">supresso</button>
                  ...
                  <li class="vr"></li>
                  <li>
                     <a href="news-13.html" class="text-reset text-decoration-none opacity-75-hover text-capitalize" data-i18n="nav_news">berita</a>
                  </li>
                  <li class="vr"></li>
                  <li>
